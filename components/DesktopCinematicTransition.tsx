...
export default function DesktopCinematicTransition() {
  ...
  const marqueeFilter = useTransform(scrollYProgress, [0.03, 0.09], ["blur(0px)", "blur(4px)"]);
  const marqueeDuration = useTransform(scrollYProgress, [0.03, 0.09], ["22s", "38s"]);
  const heroShellClip = useTransform(scrollYProgress, [0.12, 0.26], ["inset(0% 0% 0% 0%)", "inset(0% 0% 100% 0%)"]);
  ...
  const aboutShellOpacity = useTransform(scrollYProgress, [0.13, 0.2, 0.42, 0.5], [0, 1, 1, 0]);
  const aboutShellClip = useTransform(scrollYProgress, [0.44, 0.56], ["inset(0% 0% 0% 0%)", "inset(0% 0% 100% 0%)"]);
  const buildY = useTransform(scrollYProgress, [0.15, 0.23, 0.43, 0.5], [80, 0, 0, 40]);
  const buildOpacity = useTransform(scrollYProgress, [0.15, 0.22, 0.43, 0.49], [0, 1, 1, 0]);
  const buildScale = useTransform(scrollYProgress, [0.15, 0.23, 0.43, 0.5], [0.96, 1, 1, 0.96]);
  const bioClip = useTransform(scrollYProgress, [0.17, 0.24, 0.44, 0.51], ["inset(100% 0% 0% 0%)", "inset(0% 0% 0% 0%)", "inset(0% 0% 0% 0%)", "inset(0% 0% 96% 0%)"]);
  const bioOpacity = useTransform(scrollYProgress, [0.16, 0.23, 0.44, 0.5], [0, 1, 1, 0]);
  const bioY = useTransform(scrollYProgress, [0.17, 0.24, 0.44, 0.5], [32, 0, 0, 28]);
  const paperOpacity = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.5], [0, 1, 1, 0]);
  const paperScale = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.51], [0.82, 1, 1, 0.82]);
  const paperRotate = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.51], [-6, 0, 0, 6]);
  const paperSkewX = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.51], [-8, 0, 0, 8]);
  const paperSkewY = useTransform(scrollYProgress, [0.18, 0.25], [4, 0]);
  const paperFilter = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.51], ["blur(6px)", "blur(0px)", "blur(0px)", "blur(6px)"]);
  const paperClip = useTransform(scrollYProgress, [0.18, 0.25, 0.44, 0.51], ["inset(0% 0% 40% 0%)", "inset(0% 0% 0% 0%)", "inset(0% 0% 0% 0%)", "inset(0% 0% 40% 0%)"]);
  const backendAboutY = useTransform(scrollYProgress, [0.2, 0.27, 0.45, 0.51], [48, 0, 0, 48]);
  const backendAboutOpacity = useTransform(scrollYProgress, [0.2, 0.26, 0.45, 0.5], [0, 1, 1, 0]);
  const backendAboutScale = useTransform(scrollYProgress, [0.2, 0.27], [0.95, 1]);
  const hardwareX = useTransform(scrollYProgress, [0.21, 0.28, 0.45, 0.51], [60, 0, 0, 60]);
  const hardwareOpacity = useTransform(scrollYProgress, [0.21, 0.27, 0.45, 0.5], [0, 1, 1, 0]);
  const interestsY = useTransform(scrollYProgress, [0.22, 0.29, 0.45, 0.51], [-40, 0, 0, -36]);
  const interestsOpacity = useTransform(scrollYProgress, [0.22, 0.28, 0.45, 0.5], [0, 1, 1, 0]);
  const interestsScale = useTransform(scrollYProgress, [0.22, 0.29], [0.96, 1]);
  const builtScale = useTransform(scrollYProgress, [0.24, 0.31, 0.46, 0.52], [0.88, 1, 1, 0.88]);
  const builtOpacity = useTransform(scrollYProgress, [0.24, 0.3, 0.46, 0.51], [0, 1, 1, 0]);
  const footerY = useTransform(scrollYProgress, [0.28, 0.34, 0.42, 0.48], [24, 0, 0, 24]);
