...
export default function Navbar() {
  ...
  return (
    <nav className="absolute top-[28px] left-[48px] right-[48px] h-[56px] z-50 flex justify-between items-center pointer-events-none max-w-[1344px] mx-auto">
      <div className="pointer-events-auto">
        ...
        >
          <span className="text-[44px] font-[900] text-[#111] pt-[8px] leading-none tracking-tight font-archivo">A.</span>
        </motion.div>
      </div>
      ...
      <div className="pointer-events-auto hidden md:flex items-center">
        {links.map((link, i) => (
          <div key={link} className="flex items-center">
            ...
            {i < links.length - 1 && (
              <span className="w-[1px] h-[28px] bg-[#111] opacity-30 mx-[22px]"></span>
            )}
          </div>
        ))}
      </div>
