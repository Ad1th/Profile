...
export default function SkillsFooter({ viewportTransition }: { viewportTransition: boolean }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <span
          ...
          style={{ color: "#F0EBE0", fontSize: viewportTransition ? 10 : 13, fontWeight: 700, opacity: 0.85 }}
        >
      ...
      <div className="flex items-center gap-3">
        <span
          ...
          style={{ color: "#CFDE00", fontSize: viewportTransition ? 10 : 13, fontWeight: 700 }}
        >
